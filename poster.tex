...
\begin{column}{0.46\paperwidth}
  ...
  \begin{block}{Timing protocol}
    \begin{itemize}
      ...
      \item Evaluation runtime is excluded; the training timer is stopped while running validation.
      \item Prior generation time is excluded (using a pre-generated prior dump is allowed).
    \end{itemize}
