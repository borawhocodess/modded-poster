...
NanoTabPFN in \textasciitilde10 minutes
...
\institute[shortinst]{\inst{1} University of Freiburg \samelineand \inst{2} ELLIS Institute Tübingen \samelineand \inst{2} Prior Labs}
...
\footercontent{
  ...
  % TODO: ELLIS Institute Tübingen, Uni Freiburg and priorlabs logo
...
\begin{column}{0.46\paperwidth}
  ...
  \begin{block}{Introduction}
    ...
    \heading{Goal}
      ...
      % TODO: beat Random Forest (~0.8068)
...
\begin{column}{0.44\paperwidth}
  ...
  \begin{block}{Record history}
    ...
    % TODO: update and highlight these more
  ...
  \begin{exampleblock}{Join the race!}
    ...
    % TODO: the qr code is too big, we can use that space for something better and a much smaller one also suffices
